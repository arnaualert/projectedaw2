...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/js/bootstrap.bundle.min.js" integrity="sha384-w76AqPfDkMBDXo30jS1Sgez6pr3x5MlQ1ZAGC+nuZB+EYdgRZgiwxhTBTkF7CXvN" crossorigin="anonymous"></script><div id="level-gnav">
        ...
        <ul class="level-1">
          ...
          <li><a href="../../projectedaw2/pruebafotosusuario/pruebafotos (copy)/fotos.php">Fotos</a></li>
...
<table style="margin: 0 auto;"> 
    ...
    <tr>
     ...
     width: 420px;"><?php echo $item['descripcio']?></td></tr>
        <tr><br><br><td> <br><a onclick="alert('Inicia sessió per a reservar')" href="#"><button title="Llistat de Personal" class="botoMenuPrincipalEsquerra"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-file-person-fill" viewBox="0 0 16 16">
