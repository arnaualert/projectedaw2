...
class User {
    ...
    public function findUserByEmailOrUsername($email, $username){
        $this->db->query('SELECT * FROM treballadors WHERE usersUid = :username OR usersEmail = :email');
    ...
    public function register($data){
        $this->db->query('INSERT INTO treballadors (usersName, usersEmail, usersUid, usersPwd) 
