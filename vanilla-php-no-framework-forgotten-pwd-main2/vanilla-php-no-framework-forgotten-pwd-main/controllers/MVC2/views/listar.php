...
<table style="margin: 0 auto;">
    ...
    <tr>
        ...
        <tr><br><td><br><img  src="/a/projectedaw2/MVC2/views/archerytag.jpeg" style=" height: 220px ;
     ...
     width: 420px;"><?php echo $item['descripcio']?></td></tr>
        <tr><br><br><td> <br><a href="/a/projectedaw2/vanilla-php-no-framework-forgotten-pwd-main2/vanilla-php-no-framework-forgotten-pwd-main/MVC2/reservas.php"><button title="Llistat de Personal" class="botoMenuPrincipalEsquerra"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-file-person-fill" viewBox="0 0 16 16">
