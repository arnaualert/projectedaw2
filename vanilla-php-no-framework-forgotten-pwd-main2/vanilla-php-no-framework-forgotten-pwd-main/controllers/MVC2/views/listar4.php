...
.nav-masthead .active {
  color: #fff;
  border-bottom-color: #fff;istado4
...
<table style="margin: 0 auto;" >
    ...
    <tr>
        ...
        <tr><br><td><br><img src="/a/projectedaw2/MVC2/views/bubble.jpg"><br><br></td></tr>
        <tr><br><br><td style="border:1px solid black; padding:30px; white-space: pre-line;"><?php echo $item['descripcio']?></td></tr>
        <tr><br><br><td> <br><a href="/a/projectedaw2/MVC2/index2.php"><button title="Llistat de Personal" class="botoMenuPrincipalEsquerra"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-file-person-fill" viewBox="0 0 16 16">
