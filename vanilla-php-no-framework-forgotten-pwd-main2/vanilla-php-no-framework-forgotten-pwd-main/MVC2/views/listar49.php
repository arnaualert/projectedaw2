...
<table style="margin: 0 auto;">
    ...
    while($item = $listado49->fetch())
    {
    ?>
    <tr>
        <td ><?php echo $item['nom_activitat']?><br><br></td> </tr>
        <tr><br><td><br><img src="../MVC2/views/bubble.jpg" style=" height: 220px ;
     width: 420px;"><br><br></td></tr>
        ...
        <tr><br><br><td> <br><a href="../reservas10.php"><button title="Llistat de Personal" class="botoMenuPrincipalEsquerra"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-file-person-fill" viewBox="0 0 16 16">
