...
class ItemsController
{
    ...
    public function listar88()
    {
        ...
        //Le pedimos al modelo todos los items
        $listado88 = $items->listadoTotal88();

        //Pasamos a la vista toda la información que se desea representar
        $data['listado88'] = $listado88;

        //Finalmente presentamos nuestra plantilla
        $this->view->show("listar88.php", $data);
    }
    ...
    public function listare()
    {
        ...
        //Le pedimos al modelo todos los items
        $listadoe = $items->listadoTotale();
        //Pasamos a la vista toda la información que se desea representar
        $data['listadoe'] = $listadoe;
        //Finalmente presentamos nuestra plantilla
        $this->view->show("listare.php", $data);
