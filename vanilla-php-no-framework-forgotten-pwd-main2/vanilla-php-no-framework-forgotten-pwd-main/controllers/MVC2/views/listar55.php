...
<table  style="margin: 0 auto;">
    ...
    <tr>
        ...
        <tr><br><td><br><img src="projectedaw2/MVC2/views/impro.jpeg" style=" height: 220px ;
     width: 420px;"><br><br></td></tr>
        ...
        <tr><br><br><td> <br><a href="../reservas.php"><button title="Llistat de Personal" class="botoMenuPrincipalEsquerra"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-file-person-fill" viewBox="0 0 16 16">
