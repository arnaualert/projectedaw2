  ...
  <center>
    ...
    <form action="procesar_pago.php" method="post">
        <legend>Información de pago:</legend>
            ...
            <input type="text" name="actividad" style="text-align: center;" value="<?php echo'Improvicació'?>" readonly><br><br>
            ...
            <input type="radio" id="contactChoice3" name="contact" value="mail" onclick=""/>targeta
<br><br>
