...
CREATE TABLE users_treballador (
    id_treballador INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
    treballador VARCHAR(50) NOT NULL UNIQUE,
    password VARCHAR(255) NOT NULL,
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
    targeta VARCHAR (20)
); 
INSERT INTO users_treballador(id_treballador, treballador, password,created_at ,targeta) VALUES

(1,"admin","lukstroplantair",null,null);
...
INSERT INTO users_client (id_client, client, password ,targeta) VALUES
(1,"client","p@ssw0rd",null);


CREATE TABLE reserves (
    id_reserva INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
    dia_reserva DATE,
    cancelar_reserva VARCHAR(30),
    id_treballador int,
    FOREIGN KEY (id_treballador) REFERENCES users_treballador(id_treballador)
);
INSERT INTO reserves (id_reserva, dia_reserva, cancelar_reserva,id_treballador) VALUES
(1,null,null,null);
