...
<table  style="margin: 0 auto;">
    ...
    <tr>
     ...
     width: 420px;"><br><br></td></tr>
        ...
        <tr><br><br><td> <br><a href="../reservas8.php"><button title="Llistat de Personal" class="botoMenuPrincipalEsquerra"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-file-person-fill" viewBox="0 0 16 16">
