...
class ResetPasswords{
    ...
    public function __construct(){
        ...
        $this->mail->Port = 2525;
        $this->mail->Username = '9b2a9c9ff7a0ff';
        $this->mail->Password = '4b940d7695cdaa';
    }
    ...
    public function sendEmail(){
        ...
        $url = 'http://localhost/a/projectedaw2/vanilla-php-no-framework-forgotten-pwd-main2/vanilla-php-no-framework-forgotten-pwd-main/create-new-password.php?selector='.$selector.'&validator='.bin2hex($token);
